...
- **`sim.eigs`** — the nonlinear longitudinal 3-DOF model: coefficient
  ...
  0.15% (arms in ORACLE.md, sixteen-plant fault matrix in
...
bash tests/test_sim_planted.sh # 16 rung-1 plants, exact red sets + manifest
...
bash tests/test_latsim_planted.sh # 15 rung-2 plants, exact red sets + manifest
